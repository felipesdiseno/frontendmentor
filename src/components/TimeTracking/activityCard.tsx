...
function ActivityCard({
  ...
  return (
    <div
      className="flex flex-col justify-end rounded-xl relative p-2 md:w-[255px] md:h-[284px] sm:w-[314px] sm:h-[202px]"
    ...
    >
      ...
      <div className="bg-[#1C1F4A] flex flex-col hover:cursor-pointer hover: rounded-xl md:w-[255px] md:h-[244px] sm:w-[314px] sm:h-[162px] z-10 absolute bottom-0 left-0 right-0 mx-auto">
